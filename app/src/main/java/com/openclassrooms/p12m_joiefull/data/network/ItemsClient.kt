...
interface ItemsClient {
     ...
     * and retrieves the list of items. The response contains a list of [ItemApiResponse],
     ...
     *
     * @return A [Response] wrapping a list of [ItemApiResponse]. If the request is successful,
     *         the body contains the list of items. Otherwise, the response will indicate an error.
     */
    @GET("clothes.json")
    suspend fun getItems(): Response<List<ItemApiResponse>>
